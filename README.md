...
* Сборка осуществляется для микроконтроллера MDR1986BE92 (ближайший аналог STM32F103x)
* Отладочная плата LDM-HELPER-K1986BE92QI
...
* [/bin](/bin) - логи компиляции и артефакты
  * [bin/TestNami.build_log.htm](bin/TestNami.build_log.htm)   - лог компиляции
